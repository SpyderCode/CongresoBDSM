		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					String[] columns = {"idArticulo", "nombreArt", "idInvestigador","aceptado","Revista"};
					...
					String sql="SELECT articulo.idArticulo,articulo.nombreArt,articulo.idInvestigador,"
							+ "articulo.aceptado,revista.Nombre FROM articulo,artirev,revista where "
					...
					rs.beforeFirst();
					 ...
					 while (rs.next()) {
						 ...
						 String vere=rs.getString("aceptado");
